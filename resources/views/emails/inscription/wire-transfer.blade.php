...
<html lang="en-US">
    ...
    <body>
        ...
        <div><span class="font-weight: bold; color: #660087;"></span> {{ $name }}, muchas gracias por inscribirse en el Maratón Fitness y “Sumarse al Efecto Mariposa”. Hemos bloqueado una plaza en <strong>{{ $activity->name }}</strong> en el horario <strong>{{ $timeslot }}</strong>.</div>
